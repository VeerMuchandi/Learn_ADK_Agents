...
def get_address_of_place(tool_context: ToolContext, place_name: str) -> str:
  """
  Finds the full address of a named place, like 'home', 'office', or a business name.
  ...
  Returns:
      The formatted address of the place, or an error message.
  """
  ...
  try:
    ...
    return first_place.get("formattedAddress", "Address not found.")
